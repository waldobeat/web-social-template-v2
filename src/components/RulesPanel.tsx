            ...
            <div>
              ...
              <ul className="mt-1.5 space-y-1 text-[10px]">
                <li className="flex items-center gap-2">
                  <span className="inline-flex h-2 w-2 rounded-full bg-neon-green shadow-[0_0_6px_rgba(0,255,65,0.6)]"></span>
                  <span className="text-gray-300"><strong className="text-neon-green">RANGO 1:</strong> ENCONTRADA</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="inline-flex h-2 w-2 rounded-full bg-neon-green shadow-[0_0_6px_rgba(0,255,65,0.4)]"></span>
